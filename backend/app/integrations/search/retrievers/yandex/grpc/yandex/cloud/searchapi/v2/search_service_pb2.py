...
from app.integrations.search.retrievers.yandex.grpc.yandex.cloud.api import operation_pb2 as yandex_dot_cloud_dot_api_dot_operation__pb2
from app.integrations.search.retrievers.yandex.grpc.yandex.cloud.operation import operation_pb2 as yandex_dot_cloud_dot_operation_dot_operation__pb2
from app.integrations.search.retrievers.yandex.grpc.yandex.cloud import validation_pb2 as yandex_dot_cloud_dot_validation__pb2
from app.integrations.search.retrievers.yandex.grpc.yandex.cloud.searchapi.v2 import search_query_pb2 as yandex_dot_cloud_dot_searchapi_dot_v2_dot_search__query__pb2
