...
import { QuantumEntitiesModal } from './QuantumEntitiesModal'
...
export function QuantaList({ items }: QuantaListProps) {
  const [selectedQuantum, setSelectedQuantum] = useState<QuantumOutDto | null>(null)
  const [isModalOpen, setIsModalOpen] = useState(false)

  const handleOpenEntities = (q: QuantumOutDto) => {
            ...
            <li key={q.id} className="quanta-list__card">
              <div className="quanta-list__card-header">
                ...
                <div className="quanta-list__scores" aria-label="Оценки релевантности">
                  ...
                  {q.total_score != null && (
                    <span
                      className="quanta-list__score quanta-list__score_total"
                      title="Итоговая оценка (total_score)"
                    >
              ...
              <div className="quanta-list__footer">
                <a
                ...
                <button
                  type="button"
                  className="quanta-list__entities-btn"
                  onClick={() => handleOpenEntities(q)}
                >
                  Сущности
                </button>
              </div>
